...
class AgentSession:
    ...
    def __init__(self, id):
        ...
        meals_agent = AssistantAgent(
            ...
            "Transfer to the the triage agent if you can't help. Transfer to the user agent after performing the requested meals actions."
            "If the user doesn't specify if a meal is frozen, default to their preference if stored in memory. If no preference is stored, ask the user and save to memory.",
